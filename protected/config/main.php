...
return array(
	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
				...
				'novostroiki/admin/page/<page_id:\d+>' => 'novostroiki/admin',			
				...
				'metki/<en_title:[\w\-]+>' => 'metki/view',
				'metki/<en_title:[\w\-]+>/page/<page_id:\d+>' => 'metki/view',
				'news/' => 'news/index',
	...
	//	),
		...
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=domscanlo',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => '',
			'charset' => 'utf8',
