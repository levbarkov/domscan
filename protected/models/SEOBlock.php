...
class SEOBlock extends CActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('en_name, text, text_2, text_3, text_4, email_info, title, description', 'safe'),
			array('id, en_name, text, text_2, text_3, text_4, email_info', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'text' => Yii::t('app', 'Левое верхнее'),
			'text_2' => Yii::t('app', 'Левое нижнее'),
			'text_3' => Yii::t('app', 'Правое верхнее'),
			'text_4' => Yii::t('app', 'Правое нижнее'),
