...
class Guides extends CActiveRecord
{
	...
	public $category = 'Гайды';
	public $category_url = '/guides/';
	...
	{
		return '/guides/'.$this->id.'-'.$this->en_title;
	}
	...
	public function afterDelete()
	{
		...
		if($this->photo_wide)
			if(is_file(dirname(Yii::app()->request->scriptFile).$this->photo_wide))
				@unlink(dirname(Yii::app()->request->scriptFile).$this->photo_wide);
