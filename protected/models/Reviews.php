...
class Reviews extends CActiveRecord
{
	...
	public $category = 'Обзоры';
	public $category_url = '/reviews/';
	...
	public function rules()
	{
		...
		return array(
			...
			array('html, datepublish, additional, type, photo, seo_title, seo_description', 'safe'),
    ...
    {
	    return '/reviews/'.$this->id.'-'.$this->en_title;
    }
