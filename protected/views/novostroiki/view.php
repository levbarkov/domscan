            ...
            <div class="property__wrapper">
            	<div class="property__title-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="/#?view=table&type=<?= $model->type ?>&subtype=<?= $model->subtype ?>"><?= $subtype_string ?> <?= $type_string ?></a></li>
                        <li><?= $model->title ?></li>
                    </ol>
                ...
                <div class="row">
                    <div class="col-xs-8" ng-app="property" ng-controller="propertyCtrl">
						...
						<? if($model->attached_images): ?>
                            <button if="phototab" type="button" ng-class="{active: toggle=='gallery'}" ng-click="changeToggle('gallery')"
                        ...
                        <div class="gallery property__gallery" ng-show="toggle == 'gallery'">
                            <div data-keyboard="true" data-width="100%" data-height="400" data-maxheight="400" class="fotorama" data-nav="thumbs"  data-loop="true">
                            <? if($model->image_large): ?>
                                <? $date = Yii::app()->easyImage->thumbOf($_SERVER['DOCUMENT_ROOT'].$image->image_large, array('type' => 'jpg','watermark' => array('watermark' => '/img/watermark-2.png', 'opacity' => 100)));
								echo $date; ?>    
                            <? endif ?>
                            <? foreach($model->attached_images as $image): ?> 
                                <? $date = Yii::app()->easyImage->thumbOf($_SERVER['DOCUMENT_ROOT'].$image->uploaddir.$image->name, array('type' => 'jpg','watermark' => array('watermark' => '/img/watermark-2.png', 'opacity' => 100)));
								echo $date; ?>                            
                            <? endforeach ?>
                            </div>
                        </div>
							...
							<? if ($model->seller_phone): ?>
	                            <ul class="property__contacts-list-phone">
	                                <li class="property__contacts-list-phone-item">
	                                	<a href="#" id="show_phone" style="color: #393939; border-bottom:1px dotted; font-family: 'OpenSans', sans-serif; font-size: 18px; margin-left: 6px;">Показать телефон</a>
