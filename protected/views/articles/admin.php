...
<a href="/articles/create" class="btn btn-warning"><i class="icon-plus icon-white"></i> Добавить статью</a>
<div class="block">
    	...
    	<table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              	<nobr><a class="btn btn-info" href="/articles/update/<?= $otziv->id ?>"><i class="icon-pencil icon-white"></i></a>
              	<a class="btn btn-danger" href="/articles/delete/<?= $otziv->id ?>" onclick="return confirm('Вы точно хотите удалить? Эту операцию отменить нельзя!')"><i class="icon-remove icon-white"></i></a></nobr>
              </td>
            </tr>
            <? endforeach ?>
          </tbody>
        		...
        		<div class="dataTables_paginate paging_bootstrap pagination" style="float:right;">
        			<ul>
        				...
        				<? for($i = 1; $i <= $page_count; $i++): ?>
        					<? 
	        					$assemble_link = '/articles/admin/page/'.$i;        					
